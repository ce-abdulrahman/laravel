...
@section('title', 'دەستکاریکردنی بانەر')
@section('page-title', 'دەستکاریکردنی بانەر')

@section('breadcrumb')
    <li class="breadcrumb-item"><a href="{{ route('banners.index') }}">بەڕێوەبردنی بانەرەکان</a></li>
    <li class="breadcrumb-item active" aria-current="page">دەستکاریکردنی بانەر</li>
@endsection
...
<div class="quran-dashboard">
    ...
    <div class="d-flex align-items-center justify-content-between mb-4">
        <div>
            <h1 class="h4 mb-1">دەستکاریکردنی بانەر</h1>
            <div class="text-muted">دەستکاری زانیارییەکانی ئەم بانەرە بکە.</div>
        </div>
