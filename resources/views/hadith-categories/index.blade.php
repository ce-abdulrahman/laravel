...
@section('title', 'هاوپۆلەکانی فەرموودە')
@section('page-title', 'هاوپۆلەکانی فەرموودە')
 
@section('breadcrumb')
    <li class="breadcrumb-item active" aria-current="page">هاوپۆلەکانی فەرموودە</li>
@endsection
...
<div class="quran-dashboard">
    ...
    <div class="d-flex flex-column flex-lg-row gap-3 align-items-lg-center justify-content-between mb-4">
        <div>
            <h1 class="h4 mb-1">هاوپۆلەکانی فەرموودە</h1>
            <div class="text-muted">هاوپۆلەکانی فەرموودە (ڕەوشت، بیروباوەڕ، پەرستشەکان) بەڕێوەببە.</div>
        </div>
                    ...
                    <tr>
                        ...
                        <td>
                            <div class="quran-table-actions justify-content-end">
                                ...
                                <form method="POST"
                                      action="{{ route('hadith-categories.destroy', $cat) }}"
                                      class="d-inline"
                    ...
                    <tr>
                        <td colspan="7">
                            <div class="quran-table-empty">
                                ...
                                <p>هیچ هاوپۆلی فەرموودەیەک نەدۆزرایەوە لە داتابەیسدا.</p>
...
<script>
    function confirmDelete(event, catName) {
        ...
        if (confirm('دڵنیای لە سڕینەوەی ئەم هاوپۆلە؟ هەموو فەرموودەکانی ژێر ئەم هاوپۆلەش دەسڕێنەوە!\n\n' + catName)) {
            form.submit();
        }
        return false;
    }
        ...
        if (searchInput) {
            searchInput.addEventListener('keypress', function(e) {
                if (e.key === 'Enter') {
                    ...
                    if (query) {
                        window.location.href = '{{ route("hadith-categories.index") }}?q=' + encodeURIComponent(query);
                    } else {
                        window.location.href = '{{ route("hadith-categories.index") }}';
                    }
                }
            });
        }
