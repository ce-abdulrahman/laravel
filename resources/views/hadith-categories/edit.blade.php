...
@section('title', 'دەستکاریکردنی هاوپۆلی فەرموودە')
@section('page-title', 'دەستکاریکردنی هاوپۆلی فەرموودە')
...
<div class="quran-dashboard">
    ...
    <div class="d-flex align-items-center justify-content-between mb-4">
        <div>
            <h1 class="h4 mb-1">دەستکاریکردنی هاوپۆلی فەرموودە</h1>
            <div class="text-muted">زانیاری و ڕێکخستنی هاوپۆلی فەرموودە دەستکاری بکە.</div>
        </div>
