@extends('layouts.app')
@section('title', __('achievements.titles.edit'))
@section('page-title', __('achievements.titles.edit'))

@section('breadcrumb')
    <li class="breadcrumb-item"><a href="{{ route('achievements.index') }}">{{ __('achievements.titles.index') }}</a></li>
    <li class="breadcrumb-item active" aria-current="page">{{ __('achievements.titles.edit') }}</li>
@endsection
...
<div class="quran-dashboard">
    ...
    <div class="d-flex align-items-center justify-content-between mb-4">
        <div>
            <h1 class="h4 mb-1">{{ $achievement->icon }} {{ __('achievements.titles.edit') }}: {{ $achievement->name ?: $achievement->key }}</h1>
        ...
        <form method="POST" action="{{ route('achievements.update', $achievement) }}">
            ...
            <div class="quran-form">
                ...
                <div class="quran-form-section mb-4">
                    ...
                    <div class="row g-3">
                        ...
                        <div class="col-md-4">
                            <label class="quran-form-label">{{ __('achievements.fields.key') }}</label>
                            <input type="text" value="{{ $achievement->key }}"
                                   class="quran-form-control font-monospace bg-body-tertiary" readonly>
                            <div class="form-text small text-muted">
                                <i class="bi bi-lock me-1"></i>{{ __('achievements.fields.key') }}
                            </div>
                        </div>
                        <div class="col-md-3">
                        ...
                        <div class="col-md-3">
                            ...
                            <input type="number" name="sort_order" value="{{ old('sort_order', $achievement->sort_order) }}" min="0"
                ...
                <div class="quran-form-section mb-4">
                    ...
                    <div class="row g-3">
                        <div class="col-md-6">
                            ...
                            <select name="condition_type" class="quran-form-control @error('condition_type') is-invalid @enderror" required>
                                @foreach($conditionTypes as $typeKey => $typeLabel)
                                    <option value="{{ $typeKey }}" {{ old('condition_type', $achievement->condition_type) === $typeKey ? 'selected' : '' }}>
                        ...
                        <div class="col-md-3">
                            ...
                            <input type="number" name="condition_value" value="{{ old('condition_value', $achievement->condition_value) }}" min="1"
                        ...
                        <div class="col-md-3">
                            ...
                            <input type="number" name="version" value="{{ old('version', $achievement->version) }}" min="1"
                                   class="quran-form-control">
                        </div>
                    </div>
                </div>
                ...
                <div class="quran-form-section mb-4">
                    ...
                    <div class="row g-3">
                        <div class="col-md-4">
                            ...
                            <select name="reward_type" class="quran-form-control">
                                @foreach($rewardTypes as $rtKey => $rtLabel)
                                    <option value="{{ $rtKey }}" {{ old('reward_type', $achievement->reward_type) === $rtKey ? 'selected' : '' }}>
                                        {{ $rtKey }} &mdash; {{ $rtLabel }}
                                    </option>
                                @endforeach
                            </select>
                        ...
                        <div class="col-md-4">
                            ...
                            <input type="number" name="reward_points" value="{{ old('reward_points', $achievement->reward_points) }}" min="0"
                                   class="quran-form-control">
                        </div>
                    </div>
                </div>
                ...
                <div class="quran-form-section mb-4">
                    ...
                    <ul class="nav nav-tabs quran-tabs mb-3" role="tablist">
                        ...
                        <li class="nav-item" role="presentation">
                            <button class="nav-link {{ $i === 0 ? 'active' : '' }}"
                                    id="tab-edit-{{ $lang->code }}"
                                    data-bs-toggle="tab"
                                    data-bs-target="#pane-edit-{{ $lang->code }}"
                    ...
                    <div class="tab-content">
                        @foreach($languages as $i => $lang)
                        @php $t = $achievement->translations->firstWhere('locale', $lang->code); @endphp
                        <div class="tab-pane fade {{ $i === 0 ? 'show active' : '' }}"
                             id="pane-edit-{{ $lang->code }}" role="tabpanel">
                            <div class="row g-3">
                                <div class="col-md-5">
                                    <label class="quran-form-label" for="edit_name_{{ $lang->code }}">
                                        ناوی دەستکەوتە ({{ $lang->native_name }})
                                    </label>
                                    <input type="text"
                                ...
                                <div class="col-md-7">
                                    <label class="quran-form-label" for="edit_desc_{{ $lang->code }}">
                ...
                <div class="quran-form-section mb-4">
                    ...
                    <div class="d-flex gap-4">
                        ...
                        <div class="quran-form-check">
                            ...
                            <input type="checkbox" name="is_hidden" id="is_hidden" class="quran-form-check-input" value="1"
                                   {{ old('is_hidden', $achievement->is_hidden) ? 'checked' : '' }}>
            ...
            <div class="quran-form-actions mt-4">
                <button type="submit" class="quran-btn quran-btn-primary">
                    <i class="bi bi-save me-1"></i> {{ __('achievements.actions.update') }}
                </button>
