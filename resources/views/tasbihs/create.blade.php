...
@section('title', 'دروستکردنی تەسبیحی نوێ')
@section('page-title', 'دروستکردنی تەسبیحی نوێ')

@section('breadcrumb')
    <li class="breadcrumb-item"><a href="{{ route('tasbihs.index') }}">بەڕێوەبردنی تەسبیحەکان</a></li>
    <li class="breadcrumb-item active" aria-current="page">دروستکردنی تەسبیح</li>
@endsection
...
<div class="quran-dashboard">
    ...
    <div class="d-flex align-items-center justify-content-between mb-4">
        <div>
            <h1 class="h4 mb-1">دروستکردنی تەسبیحی نوێ</h1>
            <div class="text-muted">زیکر و تەسبیحی نوێ زیاد بکە بۆ ئەوەی لەسەر پەڕەی تەسبیحی مۆبایل پیشان بدرێت.</div>
        </div>
