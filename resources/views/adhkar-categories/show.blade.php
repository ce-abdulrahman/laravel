            ...
            <div class="quran-card mb-4" style="
                ...
                <div class="quran-card-body pt-0">
                    <div class="row g-4">
                        {{-- Kurdish --}}
                        <div class="col-md-4">
                            <label class="text-muted small d-block mb-1">{{ __('adhkar_categories.fields.name_ku') }}</label>
                            <div style="font-size: 1.1rem; font-weight: 600; color: var(--quran-text-primary);">
                                {{ $category->name_ku }}
                            </div>
                        </div>
                        {{-- Arabic --}}
                        <div class="col-md-4">
                            <label class="text-muted small d-block mb-1">{{ __('adhkar_categories.fields.name_ar') }}</label>
                        ...
                        {{-- English --}}
                        <div class="col-md-4">
                            <label class="text-muted small d-block mb-1">{{ __('adhkar_categories.fields.name_en') }}</label>
                    ...
                    <div>
                        <label class="text-muted small d-block mb-2">{{ __('adhkar_categories.fields.icon') }}</label>
                        <div class="d-flex align-items-center gap-3">
                            <div class="surah-number" style="width: 52px; height: 52px; font-size: 1.5rem; display: inline-flex;">
                            ...
                            <div>
                                ...
                                <p class="text-muted small mb-0 mt-1">{{ __('adhkar_categories.fields.icon_hint') }}</p>
                            </div>
                        </div>
                    </div>
                    @endif
