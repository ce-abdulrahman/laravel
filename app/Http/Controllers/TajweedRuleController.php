...
class TajweedRuleController extends Controller implements HasMiddleware
{
    ...
    private function getColorPalette(): array
    {
        return [
            ...
            // Solid color replacements for gradients (No duplicates)
            '#4E54C8' => 'شینی مۆراوی توند (Indigo)',
            '#11998E' => 'سەوزی دەریایی توند (Teal)',
            '#FF416C' => 'سووری پەمەیی گەش (Warm Rose)',
            '#00C6FF' => 'شینی گەش (Cyan Blue)',
            '#F9D423' => 'زەردی گەش (Bright Yellow)',
            '#f857a6' => 'پەمەیی توند (Deep Pink)',
            '#43C6AC' => 'سەوزی کاڵ (Mint Green)',
            '#7F00FF' => 'مۆری ئارام (Violet)',
            '#3A1C71' => 'مۆری تاریک مامناوەند (Slate Purple)',
            '#159957' => 'سەوزی قووڵ (Forest Green)',
            '#0052D4' => 'شینی قووڵ (Royal Blue)',
            '#E55D87' => 'پەمەیی تاریک (Dark Rose)',
            '#FF9966' => 'پرتەقاڵی کاڵ (Peach)',
            '#1D976C' => 'سەوزی زمڕوتی (Emerald)',
            '#8A2387' => 'مۆری گەش (Electric Violet)',
            '#f953c6' => 'پەمەیی تۆخ (Magenta)',
            '#4ca2cd' => 'شینی کاڵ (Light Blue)',
            '#D4145A' => 'سووری پەمەیی تۆخ (Cherry)',
            '#00dbde' => 'شینی نیۆن (Neon Cyan)',

            // Black and White (adjusted/optimized for visibility in dark/light modes)
            '#121212' => 'ڕەش (تاریکی ڕەها / Dark Mode)',
            '#F8F9FA' => 'سپی (ڕوونی ڕەها / Light Mode)',
        ];
    }
