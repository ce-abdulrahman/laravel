...
class TajweedRuleSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        $rules = [
            ...
            [
                'name_en'        => 'Idgham Bighunnah (Merge with Nasal)',
                'name_ku'        => 'ئیدغامی بە غوننە',
                'name_ar'        => 'الإدغام بغنة',
                'slug'           => 'idgham-bighunnah',
                'tajweed_rule_category_id' => $cat('noon-sakinah-tanween'),
                'color_code'     => '#4CAF50',
                'description_en' => 'Merging the Noon into the following letter with a 2-beat nasal hold. Letters: ي, ن, م, و.',
                'description_ku' => 'تێکەڵکردنی نوونی ساکن یان تەنووین لەگەڵ پیتی دوای خۆی بە غوننەوە بۆ ماوەی ٢ جووڵە (ي، ن، م، و).',
                'description_ar' => 'دمج النون الساكنة أو التنوين في الحرف الذي يليها مع صوت الغنة بمقدار حركتين (ي، ن، م، و).',
                'example_text'   => 'مَن يَعْمَلْ',
                'priority'       => 11,
            ],
            [
                'name_en'        => 'Idgham Bighayr Ghunnah (Merge without Nasal)',
                'name_ku'        => 'ئیدغامی بێ غوننە',
                'name_ar'        => 'الإدغام بغير غنة',
                'slug'           => 'idgham-bighayr-ghunnah',
                'tajweed_rule_category_id' => $cat('noon-sakinah-tanween'),
                'color_code'     => '#9E9E9E',
                'description_en' => 'Merging the Noon completely into the following letter without any nasal hold. Letters: ل, ر.',
                'description_ku' => 'تێکەڵکردنی نوونی ساکن یان تەنووین لەگەڵ پیتی دوای خۆی بە تەواوی و بەبێ غوننە (ل، ر).',
                'description_ar' => 'دمج النون الساكنة أو التنوين في الحرف التالي دمجاً كاملاً من غير غنة (ل، ر).',
            ...
            [
                'name_en'        => 'Idhhar Mutlaq (Absolute Clear)',
                'name_ku'        => 'ئیزھاری ڕەها',
                'name_ar'        => 'الإظهار المطلق',
                'slug'           => 'idhhar-mutlaq',
                'tajweed_rule_category_id' => $cat('noon-sakinah-tanween'),
                'color_code'     => '#000000',
